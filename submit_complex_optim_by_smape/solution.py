...
#     print(predict('hungry_horse_reservoir_inflow', '2021-05-08', 1,
#             Path('.').resolve(), Path('../data').resolve(), Path('../data').resolve()))
#     print(predict('hungry_horse_reservoir_inflow', '2022-05-08', 1,
#                   Path('.').resolve(), Path('../data').resolve(), Path('../data').resolve()))
